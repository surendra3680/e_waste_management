...
<div class="main-wrapper">
    <div class="header">
        <div class="header-left">
            <a href="dash" class="logo"> <img src="assets1/img/IMG_20211227_102045-removebg-preview.png" width="50" height="70" alt="logo"> <span class="logoclass">Admin</span> </a>
            <a href="dash" class="logo logo-small"> <img src="assets1/img/hotel_logo.png" alt="Logo" width="30" height="30"> </a>
        </div>
        ...
        <ul class="nav user-menu">
            ...
            <li class="nav-item dropdown has-arrow">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <span class="user-img"><img class="rounded-circle" src="assets1/img/profiles/testiimonial-1-author-1.png.png" width="31" alt="raj"></span> </a>
                <div class="dropdown-menu">
                    <div class="user-header">
                        <div class="avatar avatar-sm"> <img src="assets1/img/profiles/testiimonial-1-author-1.png.png" alt="User Image" class="avatar-img rounded-circle"> </div>
                        <div class="user-text">
                            <h6>Surendra Rajput</h6>
                            <p class="text-muted mb-0">Administrator</p>
                        </div>
                    </div> <a class="dropdown-item" href="profile">My Profile</a> <a class="dropdown-item" href="#">setting</a> <a class="dropdown-item" href="logout">Logout</a> </div>
            </li>
        </ul>
        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="submenu"> <a href="#"><i class="fas fa-suitcase"></i> <span> Collection Employee </span> <span class="menu-arrow"></span></a>
                    ...
                    <li class="submenu"> <a href="#"><i class="fas fa-user"></i> <span> Customers </span> <span class="menu-arrow"></span></a>
                        <ul class="submenu_class" style="display: none;">
                            <li><a href="datacustomer"> All customers </a></li>
                            <li><a href="#"> Edit Customer </a></li>
                            <li><a href="#"> Add Customer </a></li>
                        </ul>
                    </li>
                    <li class="submenu"> <a href="#"><i class="fas fa-key"></i> <span> Department </span> <span class="menu-arrow"></span></a>
                        <ul class="submenu_class" style="display: none;">
        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        <h3 class="page-title mt-3">Good Morning Surendra Rajput!</h3>
                        <ul class="breadcrumb">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="card card-chart">
                        <div class="card-header">
                            <h4 class="card-title">Collection Area</h4>
                        </div>
                        <div class="card-body">
