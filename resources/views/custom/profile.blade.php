    ...
    <div class="header">
        ...
        <ul class="nav user-menu">
            ...
            <li class="nav-item dropdown has-arrow">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <span class="user-img"><img class="rounded-circle" src="assets1/img/profiles/testiimonial-1-author-1.png.png" width="31" alt="Hritik raj"></span> </a>
                <div class="dropdown-menu">
                    ...
                    </div> <a class="dropdown-item" href="profile.html">My Profile</a> <a class="dropdown-item" href="datacustomer">Customer Data</a> <a class="dropdown-item" href="logout">Logout</a> </div>
            </li>
        </ul>
    </div>
                    ...
                    <div class="profile-header">
                        <div class="row align-items-center">
                            <div class="col-auto profile-image">
                                <a href="#"> <img class="rounded-circle" alt="User Image" src="assets1/img/profiles/testiimonial-1-author-1.png.png"> </a>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-10 col-lg-6">
                                            <form action="{{route('attemptChangePassword')}}" method="Post">
                                                @csrf
                                                <div class="form-group">
